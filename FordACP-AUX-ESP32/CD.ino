 ...
 * 2026-02-22 edits for ESP32 - Daniel Wolff (info@juppiemusic.com), github.com/wolffd
 *
 */
void PlayTime()
{
...

{
  ...
  acp_tx[6] = BCD((uint8_t)(wPlayTime / 60));
  acp_tx[7] = _BV(7) | BCD((uint8_t)(wPlayTime % 60));
  acp_chksum_send(8);

  if (DEBUG_SERIAL)
  {
    Serial.print("Displaying Tracktime M");
    Serial.print(BCD(wPlayTime / 60));
    Serial.print("S");
    Serial.println(BCD(wPlayTime % 60));
  }
}
